...
<html>
  ...
  <body class="w3-light-grey">
    ...
    >
      <img
        class="w3-image"
        src="${pageContext.request.contextPath}/images/tesla-plan.jpg"
        alt="The Car"
      ...
      />
      <div class="top-left">
        <p class="fadeinTitle">Our Standard Plan</p>
        <p class="fadeinTitle">Not Shabby At All</p>
    ...
    <main class="main-content">
      <div class="fullwidth-block">
        <div class="container" id="about">
          <h1>Highlights of Our Standard Plan</h1>
         </br>
      ...
      <div class="fullwidth-block cta">
        <div class="container">
          <form action="#" id="form">
            ...
            <h2 class="form-title">Purchase Your Standard Plan</h2>
            <h3 class="form-title">$<b style="font-size: larger;">999</b>/month &nbsp; plus $<b style="font-size: larger;">99</b> discount</h3>
            ...
            <c:choose>
              <c:when test="${principal} != null">
                <button type="button" class="btn btn-outline-secondary button" id="StandardPlanPurchaseConfirmBtn">
                  Ready To Pay
                </button>
              </c:when>
              <c:otherwise>
                <button type="button" class="btn btn-outline-secondary button" id="StandardPlanUserSignUp">
                  Sign Up First
                </button>
              </c:otherwise>
            </c:choose>

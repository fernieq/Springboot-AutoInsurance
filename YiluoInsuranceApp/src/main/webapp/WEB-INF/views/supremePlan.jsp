...
pageEncoding="UTF-8"%><%@ taglib uri="http://www.springframework.org/tags/form" prefix="f"%>
...
<html>
  ...
  <body class="w3-light-grey">
    ...
    >
      <img
        class="w3-image"
        src="${pageContext.request.contextPath}/images/ferrari-plan.jpg"
        alt="The Car"
      ...
      />
      <div class="top-left">
        <p class="fadeinTitle">The Best Plan</p>
        <p class="fadeinTitle">You Can Ask For</p>
    ...
    <main class="main-content">
      <div class="fullwidth-block">
        <div class="container" id="about">
          <h1>Highlights of Our Supreme Plan:</h1>
        </br>
      ...
      <div class="fullwidth-block cta" data-bg-image="images/cloud.png">
        <div class="container">
          <form action="#" id="form">
            <h2 class="form-title">Purchase the Supreme Plan</h2>
            <h3 class="form-title">$<b style="font-size: larger;">3999</b>/month &nbsp; plus $<b style="font-size: larger;">599</b> discount</h3>
            ...
            <button type="button" class="btn btn-outline-secondary button" id="SupremePlanPurchaseConfirmBtn">
              Ready To Pay
            </button>
          </form>
        </div>
